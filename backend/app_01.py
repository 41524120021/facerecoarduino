...
import time
import json
import paho.mqtt.client as mqtt         # Import library paho-mqtt:

# Tambahkan konfigurasi MQTT:
MQTT_BROKER = "broker.hivemq.com"       # atau IP broker Anda
MQTT_PORT = 1883
...
# Load semua data wajah yang dikenal
...
def generate_frames():
    ...
    while True:
        ...
        # Jika tidak ada wajah terdeteksi selama 5 detik, reset nama jadi "-"
